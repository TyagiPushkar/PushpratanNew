...
function ApplyLeave({ open, onClose, onLeaveApplied }) {
    ...
    useEffect(() => {
        const fetchLeaveBalances = async () => {
            try {
                const response = await axios.get(`https://namami-infotech.com/PushpRatan/src/leave/balance_leave.php?empid=${user.emp_id}`);
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await axios.post('https://namami-infotech.com/PushpRatan/src/leave/apply_leave.php', leaveDetails);
            if (response.data.success) {
                onLeaveApplied();
                onClose();
            } else {
