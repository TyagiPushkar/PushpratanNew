...
function Login() {
                ...
                <Container maxWidth="lg" sx={{ display: 'flex', alignItems: 'center', minHeight: '100vh' }}>
                    <Grid container justifyContent="center">
                        <Grid item xs={12} md={6}>
                            ...
                            <Paper elevation={10} sx={{ padding: 4, borderRadius: 3, backgroundColor: 'rgba(255, 255, 255, 0.7)' }}>
    ...
    style={{
        width: '300px',
        marginBottom: '20px',
        filter: 'grayscale(100%) sepia(100%) hue-rotate(75deg) saturate(600%) brightness(45%) contrast(150%)',
    }}
/>

                                    <Avatar sx={{ m: 1, bgcolor: '#084606' }}>
                                        <LockOutlinedIcon />
                                    </Avatar>
